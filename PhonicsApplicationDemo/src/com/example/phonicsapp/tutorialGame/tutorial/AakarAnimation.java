...
public class AakarAnimation 
{
	public static void startAakarAnimation(int a)
	{
		if(a==1)
		{
			if(TutorialActivity.parrotWay == 13)
			{
				Functions.letter(14, 2, TutorialActivity.letter5, 
						TutorialActivity.letter5.getX(), TutorialActivity.letter4.getX()+TutorialActivity.letter4.getWidth(),
				...
				SoundFunction.playAudio(R.raw.tgame_t2e5, TutorialActivity.MainActivityInstace);
			}
			else if(TutorialActivity.parrotWay == 10)
			{
				Functions.letter(11, 2, TutorialActivity.letter4, 
						TutorialActivity.letter4.getX(), TutorialActivity.letter3.getX()+TutorialActivity.letter3.getWidth(),
						TutorialActivity.CAMERA_HEIGHT / 2 -30, 
						TutorialActivity.CAMERA_HEIGHT-TutorialActivity.CAMERA_HEIGHT/5-100);
			
				SoundFunction.audioPlay = true;
				SoundFunction.playAudio(R.raw.tgame_t2e4, TutorialActivity.MainActivityInstace);
			}
			else if(TutorialActivity.parrotWay == 7)
			{
				Functions.letter(8, 2, TutorialActivity.letter3, 
						TutorialActivity.letter3.getX(), TutorialActivity.letter3Pos, 
						TutorialActivity.CAMERA_HEIGHT / 2 -30, 
						TutorialActivity.CAMERA_HEIGHT-TutorialActivity.CAMERA_HEIGHT/5-100);
			
				SoundFunction.audioPlay = true;
				SoundFunction.playAudio(R.raw.tgame_t2e3, TutorialActivity.MainActivityInstace);
			
			}
			else if(TutorialActivity.parrotWay == 4)
			{
				Functions.letter(5, 4, TutorialActivity.letter2, TutorialActivity.letter2.getX(), 
						TutorialActivity.letter1.getX()+TutorialActivity.letter1.getWidth(),
						TutorialActivity.CAMERA_HEIGHT / 2 -30, 
						TutorialActivity.CAMERA_HEIGHT-TutorialActivity.CAMERA_HEIGHT/5 - 100);
				
				SoundFunction.audioPlay = true;
				SoundFunction.playAudio(R.raw.tgame_t2ee2, TutorialActivity.MainActivityInstace);
			}
			...
			{ 
				...
				SoundFunction.audioPlay = true; 
				SoundFunction.playAudio(R.raw.tgame_t2ee1, TutorialActivity.MainActivityInstace);
			}
		}
		...
		else if(a==2)
		{
			...
			{
				TutorialActivity.mScene.registerUpdateHandler(new TimerHandler((float)2.5, new ITimerCallback()
				{
					@Override
			...
			else if(TutorialActivity.parrotWay == 5)
			{
				...
				TutorialActivity.mScene.registerUpdateHandler(new TimerHandler((float) 1.5, new ITimerCallback()
				{
					...
					public void onTimePassed(TimerHandler pTimerHandler) 
					{
						// TODO Auto-generated method stub
						SoundFunction.audioPlay = true;
						SoundFunction.playAudio(R.raw.tgame_uuanim5, TutorialActivity.MainActivityInstace);
					}
				}));
...
//				SoundFunction.playAudio(R.raw.uuanim7, MainActivity.MainActivityInstace);
			...
			else if(TutorialActivity.parrotWay == 6)
			{
				...
				SoundFunction.audioPlay = true;
				SoundFunction.playAudioLoop2(R.raw.tgame_t1e3, R.raw.tgame_t1e4, TutorialActivity.MainActivityInstace);
			} 
