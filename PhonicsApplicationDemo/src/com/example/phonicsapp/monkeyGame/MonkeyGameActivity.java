...
//		MonkeyGameActivity.monkeyGameLevelSelector = 2;
	...
	public static void levelSelector(int a)
	{
		...
		else if(monkeyGameLevelSelector1[a] == 1)
		{
			...
			//aa
			if(monkeyGameMenuLetterSelector==2)
			{
				LetterActivity.letterNumber=1;
				MonkeyGameActivityActivity.startActivity(new Intent(MonkeyGameActivityActivity, LetterActivity.class));
			}
			//e
			else if(monkeyGameMenuLetterSelector==3)
			{
				LetterActivity.letterNumber=3;
				MonkeyGameActivityActivity.startActivity(new Intent(MonkeyGameActivityActivity, LetterActivity.class));
			}
			//a
			else if(monkeyGameMenuLetterSelector==15)
			{
				LetterActivity.letterNumber=4;
				MonkeyGameActivityActivity.startActivity(new Intent(MonkeyGameActivityActivity, LetterActivity.class));
			}
			//u
			else if(monkeyGameMenuLetterSelector==17)
			{
				LetterActivity.letterNumber=2;
				MonkeyGameActivityActivity.startActivity(new Intent(MonkeyGameActivityActivity, LetterActivity.class));
			}
			else
			{
